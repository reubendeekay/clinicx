...
export class ApiService {
  ...
  createUser(payload: any): Observable<any> {
    ...
    return this.http.post(`${this.baseUrl}/users/`, JSON.stringify(payload), {
      headers,
    });
  }
  ...
  createDoctors(payload: any): Observable<any> {
    ...
    return this.http.post(`${this.baseUrl}/doctors/`, JSON.stringify(payload), {
      headers,
    });
  }
  ...
  fetchAppointmentsDoctor(doctorId: any): Observable<any> {
    ...
    return this.http.get(`${this.baseUrl}/appointments/doctor/${doctorId}`, {
      headers,
    });
  }
  ...
  fetchAppointmentsBranch(branchId: any): Observable<any> {
    ...
    return this.http.get(`${this.baseUrl}/appointments/branch/${branchId}`, {
      headers,
    });
  }
